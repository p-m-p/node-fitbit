...
cp.getActivities = function (options, callback) {
  this.getResource('activities', Activities, options, callback);
};

cp.getSleep = function (options, callback) {
  this.getResource('sleep', Sleep, options, callback);
};

cp.getResource = function (type, Resource, options, callback) {
